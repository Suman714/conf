...
globalkeys = gears.table.join(
  ...
  --Screenshot
   -- screenshots
   awful.key({ }, "Print", function () awful.util.spawn_with_shell("maim ~/Pictures/screenshot/$(date +%s).png") end,
   {description = "Scrot", group = "screenshots"}),
   awful.key({ modkey           }, "Print", function () awful.util.spawn_with_shell( "maim --format=png --select ~/Pictures/screenshot/$(date +%s).png" ) end,
   {description = "Select Screenshot", group = "screenshots"}),
  ...
  awful.key({ "Control","Shift" }, "h", function() awful.tag.incmwfact(-0.05) end,
    ...
    --Swap Layout
  awful.key({ modkey,  }, "space", function() awful.tag.incnmaster(1, nil, true) end,
    { description = "increase the number of master clients", group = "layout" }),
  awful.key({ modkey, "Shift" }, "space", function() awful.tag.incnmaster(-1, nil, true) end,
